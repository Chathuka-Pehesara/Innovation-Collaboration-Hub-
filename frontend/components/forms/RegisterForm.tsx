  ...
  return (
    ...
    >
      ...
      <motion.a
        ...
        whileHover={{ scale: 1.01 }}
        whileTap={{ scale: 0.98 }}
        className="w-full py-2.5 px-4 bg-white border border-amber-900/15 dark:border-white/10 hover:bg-slate-50 dark:bg-white/5 dark:hover:bg-white/10
                   text-amber-950 dark:text-white font-bold rounded-xl text-sm transition-all shadow-sm flex items-center justify-center gap-2.5 cursor-pointer"
      >
